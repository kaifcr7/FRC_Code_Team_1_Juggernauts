...
public class AimAtTagCommandRight extends Command {
    private final CommandSwerveDrivetrain swerve;
    private final VisionSubsystem vision;
    private double strafeOffsetMeters;

    public AimAtTagCommandRight(CommandSwerveDrivetrain swerve, VisionSubsystem vision, double initialOffset) {
        this.swerve = swerve;
        this.vision = vision;
    ...
    public void execute() {
        if (vision.hasValidTarget()) {
            ...
            SmartDashboard.putNumber("strafeSpeedSetPoint = ", strafeSpeed);
