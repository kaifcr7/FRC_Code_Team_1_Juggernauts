...
{
    private Pigeon2 m_Pigeon2 = new Pigeon2(6, "ChassisCAN"); 
    ...
    public double wrapYaw(double yaw) {
        return ((yaw + 180) % 360 + 360) % 360 - 180; // Keeps yaw in [-180, 180] range
    }
    
    public void setTargetYaw(double target) {
        this.targetYaw = wrapYaw(target);
    }
    
    public double getYawError() {
        double error = wrapYaw(targetYaw - getYaw()); // Ensure error is within range
        return error;
    }
    ...
    {    
       ...
       m_Pigeon2.getPitch().refresh();
       m_Pigeon2.getRoll().refresh();
       double rawYaw = m_Pigeon2.getYaw().getValueAsDouble();
       SmartDashboard.putNumber("RAW Pigeon Yaw", rawYaw);
       SmartDashboard.putNumber("Pigy Pitch", m_Pigeon2.getPitch().getValueAsDouble());
       SmartDashboard.putNumber("Pigy Roll ", m_Pigeon2.getRoll().getValueAsDouble());
    ...
    {
        hasTargetYaw = false; // Prevents further yaw correction attempts
    }
