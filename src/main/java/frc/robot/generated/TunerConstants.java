...
public class TunerConstants {
    ...
    .withKS(0).withKV(0.1).withKA(4);
    private static final SlewRateLimiter xLimiter = new SlewRateLimiter(0.01); // Limits acceleration on X axis
    private static final SlewRateLimiter yLimiter = new SlewRateLimiter(0.01); // Limits acceleration on Y axis
    private static final SlewRateLimiter rotLimiter = new SlewRateLimiter(0.01); // Limits acceleration on Rotation

    // Joystick input values (assuming they are already defined somewhere in your code)
    double joystickX = 0.0; 
    double joystickY = 0.0; 
    double joystickRot = 0.0; 

    // Apply SlewRateLimiter to joystick inputs to limit acceleration
    double limitedX = xLimiter.calculate(joystickX);
    double limitedY = yLimiter.calculate(joystickY);
    double limitedRot = rotLimiter.calculate(joystickRot);
    ...
    public static final CANBus kCANBus = new CANBus("ChassisCAN", "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.1982421875);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.12939453125);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.22412109375);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.462158203125);
